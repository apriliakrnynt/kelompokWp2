...
class Order_m extends CI_Model
{
    ...
    public function insert_data_item()
    {
        ...
        $this->db->insert('food_order_detail', $data);

        // Jumlahkan Order
        $order_id  = $this->input->post('order_id', 'true');
        $Order     = $this->db->select_sum('order_detail_qty', 'qty')->select_sum('order_detail_waktu', 'waktu')->select_sum('order_detail_subtotal', 'total')->get_where('food_order_detail', array('order_id' => $order_id))->row();
        $dataOrder = array(
            'order_qty'   => $Order->qty,
        ...
        $this->db->where('order_id', $order_id);
        $this->db->update('food_order', $dataOrder);
    }
    ...
    public function update_data_item()
    {
        ...
        $this->db->update('food_order_detail', $data);
    ...
    public function delete_data_item($id)
    {
        ...
        $this->db->delete('food_order_detail');
    }
}
